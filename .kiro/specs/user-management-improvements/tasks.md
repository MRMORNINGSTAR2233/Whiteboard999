...
- [x] 1. Update database schema with role and lastLoginAt fields
...
- [x] 2. Create authorization utility functions
  - [x] 2.1 Implement requireAuth() function
  ...
  - [x] 2.2 Implement requireAdmin() function
  ...
  - [x] 2.3 Implement isAdmin() helper function
    - Write isAdmin(userId) to check if user has ADMIN role
    - Return boolean result
    - _Requirements: 2.6_

- [x] 3. Optimize Prisma logging configuration
  - [x] 3.1 Update Prisma client initialization
  ...
  - [x] 3.2 Add PRISMA_LOG_LEVEL environment variable
...
- [x] 4. Implement profile API routes
  - [x] 4.1 Create GET /api/user/profile route
  ...
  - [x] 4.2 Create PATCH /api/user/profile route
...
- [x] 5. Build profile page UI
  - [x] 5.1 Create profile page component
  ...
  - [x] 5.2 Create ProfileHeader component
  ...
  - [x] 5.3 Create ProfileStats component
  ...
  - [x] 5.4 Create EditProfileDialog component
...
- [x] 6. Implement admin route protection
  - [x] 6.1 Update middleware for admin routes
  ...
  - [x] 6.2 Update admin API routes with role checks
  ...
  - [x] 6.3 Update admin navigation visibility
...
- [x] 7. Add database seed for admin user
...
- [x] 8. Update NextAuth callbacks for lastLoginAt
